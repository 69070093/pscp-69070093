...
```text
ต้องการผสมสีโดยนับสีมา 2 สี แล้วผสมกัน output จะเป็นสีที่ผสมแล้ว
```
...
```text
Step 1:รับค่าสี
Step 2:นำมาเข้าเงื่อนไขการผสมสี if-else
Step 3:แสดงผล
```
...
```text
Blue เป็นสีที่มีในเงื่อนไขแต่ Green อยู่ในoutput
```
...
```text
Pink ไม่มีในเงื่อนไขใดๆ แต่ Violet อยู่ใน output
```
...
```text
ช่วยแนะนำการใส่เงื่อนไขตรงที่สีเหมือนกันให้ดีขึ้น
```

คุณยังทำอะไรด้วยตนเอง

```text
กำหนดการรับค่า สร้างเงื่อนไข และ แสดงผลลัพท์
```
