...
```text
รับค่าa  b แล้วนับช่วง x เป็น (a,b) แล้วหาจํานวน ที่หารด้วยจํานวนนับ d แล้วเหลือเศษ r
```
...
```text
-รับค่าinput
-สร้างตัวแปรไว้รับค่า
-ใช้ loop หาจำนวนที่ d หารเหลือเศษ r แล้วเก็บเข้าตัวแปร
-แสดงผลตัวแปรที่เก็บค่า
```
...
```text
เพราะต้องการดูว่า โค้ดใ้ช้ได้ตามเงื่อนไข
```
