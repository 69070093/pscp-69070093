...
```
โจทย์ต้องการโปรแกรมสลับตัวอักษรโดยตัวสุดท้ายสลับไปเป็นตัวแรกและไล่ไปเรื่อยๆ และผลลัพธ์ต้องเป็นตัวพิมพ์เล็กทั้งหมด
...
```
Step 1: คิดว่ากระบวณการที่ทำให้ได้ผลลัพธ์ตามที่โจทย์ต้องการ
Step 2: รับค่า input x มาเป็น string
Step 3: print output ออกมาเป้นค่า x ที่ได้ทำการ invert แล้วโดย ::-1 จากนั้นบังคับให้เปลี่ยนเป็นพิมพ์เล็กด้วย .lower
```
...
```
เหมือนกับแผนแรกเพราะ solution ที่เลือกใช้สามารถนำมาแก้โจทย์ได้จริง
```
...
```
เป็นชื่อของคู่ pair และมีตัวอักษรซ้ำกันมีทั้งพิมพ์ใหญ่พิมพ์เล็ก
```
...
```
อธิบายการใช้ฟังค์ชั่น
```

คุณยังทำอะไรด้วยตนเอง

```
คิดวิธีการและเขียนโค้ดหลังจากรับฟังคำแนะนำ
```
