...
```text
รวมบิลค่าอาหารที่รวมทั้งค่าอาหาร ค่าบริการ โดยค่าบริการ10%ของราคาอาหารและจะคิดขั้นต่ำ 50 บาทแต่จะไม่เกิน 1000 บาท vat7%ราคาอาหารรวมค่าบริการ
```
...
```text
Step 1:รับค่าอาหาร
Step 2:นำค่าอาหารไปคำนวณหา10%เพื่อได้ค่าบริการ
Step 3:นำค่าบริการรวมกับค่าอาหารแล้วหา7% เพื่อหาvat
Step 4:รวมค่าอาหาร ค่าบริการ vat
Step 5:แสดงผล
```
...
```text
ค่าบริการจะน้อยกว่า50 จึงนำมาทดสอบเงื่อนไข
```
...
```text
ค่าบิรการจะเกิน1000 จำนำมาทดสอบเงื่อนไข
```
